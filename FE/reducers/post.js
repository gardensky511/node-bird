...
const reducer = (state = initialState, action) => produce(state, (draft) => {
  switch (action.type) {
    case REMOVE_IMAGE:
      draft.imagePaths = draft.imagePaths.filter((imagePath, index) => index !== action.data);
      break;
    ...
    case REMOVE_POST_SUCCESS:
      ...
      draft.mainPosts = draft.mainPosts.filter((mainPost) => mainPost.id !== action.data.PostId);
      break;
